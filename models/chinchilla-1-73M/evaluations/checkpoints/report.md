# Chinchilla-1-73M Checkpoint Evaluation Report
...
Two Chinchilla-1-73M checkpoints — a **sft** model trained to step 1500 and a **d6** model trained to step 971 — were evaluated across a diverse set of 12 questions covering factual knowledge, reasoning, mathematics, code generation, creative writing, and instruction following.
